...
public interface ProjectService {
    ...
    Page<ProjectListTestRes> getProjectsTestLazy(Pageable pageable);

    Page<Project> getProjectsTestFetch(Pageable pageable);

    Page<ProjectListTestFetchRes> getProjectsTestMappedBy(Pageable pageable);
